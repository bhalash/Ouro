...
?>
        ...
        <script src="<?php printf('%s', ASSETS . '/js/min/modernizr_touch.min.js'); ?>"></script>
        ...
        <script src="<?php printf('%s', ASSETS . '/js/min/browser_detect.min.js'); ?>"></script>
        <script src="<?php printf('%s', ASSETS . '/js/min/main.min.js'); ?>"></script>
        <script src="<?php printf('%s', ASSETS . '/js/min/nav.min.js'); ?>"></script>
        <script src="<?php printf('%s', ASSETS . '/js/min/gallery.min.js'); ?>"></script>
        <script src="<?php printf('%s', ASSETS . '/js/min/team.min.js'); ?>"></script>
    </body>
</html>
